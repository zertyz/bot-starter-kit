...
1. Allow the underlying database to work in async without stalling the async workers -- e.g., waiting on a sync mutex to enforce a singlr writer. Being briefly blocked by low-latency database IO is acceptable.
