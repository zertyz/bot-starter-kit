...
mod tests {
    ...
    fn hello_world() {
        ...
        let _user_message = new_mo_message(
            &user_chat,
            "Hi, there! I've sent this message from my mobile!",
        );
        let _server_message = new_mo_message(
            &user_chat,
            "Hi, folk! I am the server and I've received your message",
        );
    }
